...
#pragma config(Motor,  mtr_S1_C3_1,     spnmtr,        tmotorTetrix, openLoop)
#pragma config(Servo,  srvo_S1_C2_1,    Arm,                  tServoContinuousRotation)
#pragma config(Servo,  srvo_S1_C2_2,    Elbow,                tServoStandard)
